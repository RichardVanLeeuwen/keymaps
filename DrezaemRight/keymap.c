  ...
  [_DVORAK] = LAYOUT_5x6(
      ...
      KC_LSFT,KC_SCLN, KC_Q  , KC_J  , KC_K  , KC_X  ,                         KC_B  , KC_M  , KC_W  , KC_V  , KC_Z  ,KC_EQL ,
                      KC_LEFT,KC_RGHT,                                                          KC_UP ,KC_DOWN,
                                      ...
                                      HOMEMOD,QWERTY ,                        KC_LCTL,KC_LALT
  ),
  ...
  [_QWERTY] = LAYOUT_5x6(
      ...
      KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                     KC_LEFT,KC_RGHT,                                                         KC_UP ,KC_DOWN,
                                      RAISE  ,KC_SPC ,                        KC_LSFT,LOWER  ,
                                      KC_LGUI,KC_ENT ,                        KC_BSPC,KC_DEL ,
                                      KC_HOME,DVORAK ,                        KC_LCTL,KC_LALT
  ),

  [_HOMEMOD] = LAYOUT_5x6(
      _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
      _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
      _______,CTL_A  ,ALT_O  ,SFT_E  ,GUI_U  ,_______,                        _______,GUI_H  ,SHI_T  ,ALT_N  ,CTL_S  ,_______,
      _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
