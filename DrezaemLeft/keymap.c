...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DVORAK] = LAYOUT_5x6(
      ...
      KC_LSFT,KC_SCLN, KC_Q  , KC_J  , KC_K  , KC_X  ,                         KC_B  , KC_M  , KC_W  , KC_V  , KC_Z  ,KC_EQL ,
                      KC_LEFT,KC_RGHT,                                                          KC_UP ,KC_DOWN,
                                      NAVI   ,MOUS_SPC,                       FUNCTIO,NUMBER ,
                                      KC_LCTL,MEDIA  ,                        SYMBOLS,KC_DEL ,
  ...
  [_SYMBOLS] = LAYOUT_5x6(
      _______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,
      _______,KC_GRV ,KC_MINS,KC_EQL ,KC_EXLM,_______,                        _______,_______,_______,_______,_______,_______,
      _______,KC_BSLS,KC_SLSH,KC_LBRC,KC_RBRC,_______,                        _______,_______,_______,_______,_______,_______,
