...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMING] = LAYOUT_5x6(
     ...
     _______ , _______  , _______  , _______  , _______  , _______  ,                         _______  , KC_END,KC_DOWN,KC_PGDN, _______  ,_______,
  ...
  [_MACROL] = LAYOUT_5x6(
     ...
     _______ , KC_CAPS  , _______  , _______  , _______  , _______  ,                         _______  , _______  , _______  , _______  , _______  ,_______,
      GMAIL  , _______  , GAMING   , _______  , _______  , _______  ,                         _______  , _______  , _______  , _______  , _______  ,_______,
